document.addEventListener('DOMContentLoaded', () =>{
    ...
    function checkBoard(){
        for(i = 0; i < winningArrays.length; i++){
            ...
            //check the squares to see if all have class of player one
            ...
            //check the squares to see if all have class of player two
    ...
    for(let i = 0; i < squares.length; i++){
        squares[i].onclick = () => {
            //if the square below current square is taken you can place on top of it
            ...
            } else alert('You can only go places above a previous peice or on the bottom row')
            checkBoard()
        }
    }
})